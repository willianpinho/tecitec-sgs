...
final class Cliente: Model {
    ...
    /// Initializes the Cliente from the
    /// database row
    init(row: Row) throws {
    ...
    // Serializes the Cliente to the database
...
extension Cliente: Preparation {
    /// Prepares a table/collection in the database
    /// for storing Clientes
...
// For example when:
//     - Creating a new Cliente (POST /usuarioss)
//     - Fetching a usuarios (GET /usuarioss, GET /usuarioss/:id)
//
extension Cliente: JSONConvertible {
...
// This allows Cliente models totime
extension Cliente: ResponseRepresentable { }

extension Cliente: Timestampable {
